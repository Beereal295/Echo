...
def main():
    ...
    print_header("Echo Journal Launcher")
    ...
    try:
        ...
        print_header("🚀 Echo Journal is running!")
        ...
        try:
            print_colored("Opening Echo Journal in your default browser...", Colors.OKCYAN)
        ...
        print_colored("\nEcho Journal stopped", Colors.OKBLUE)
