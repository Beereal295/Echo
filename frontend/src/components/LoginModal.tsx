  ...
  const validateForm = () => {
    ...
    switch (loginMethod) {
      ...
      case 'emergency':
        ...
        } else if (!formData.emergencyKeyFile.name.endsWith('.echounlock')) {
          newErrors.emergencyKeyFile = 'Invalid file type. Please select an .echounlock file' as any
        }
        break
    }
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-xl font-bold text-white">
                    {loginMethod === 'emergency' ? 'Emergency Recovery' : 'Welcome Back to Echo'}
                  </h2>
                </div>
              </div>
              <Button
                ...
                <div className="space-y-2">
                  ...
                  <div className="border-2 border-dashed border-border/50 rounded-lg p-6 text-center">
                    ...
                    <p className="text-sm text-gray-400 mb-3">
                      Upload your .echounlock recovery file
                    </p>
                    <input
                      type="file"
                      accept=".echounlock"
