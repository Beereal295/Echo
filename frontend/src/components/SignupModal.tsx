...
function SignupModal({ isOpen, onClose, onSubmit }: SignupModalProps) {
  ...
  const generateEmergencyKey = () => {
    const key = 'echo_' + crypto.randomUUID().replace(/-/g, '')
    setEmergencyKey(key)
  ...
  const downloadEmergencyKey = () => {
    ...
    a.href = url
    a.download = `${formData.name.toLowerCase().replace(/\s+/g, '_')}_recovery.echounlock`
          ...
          <div className="px-6 py-4 border-b border-border">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-xl font-bold text-white">Create Your Echo Account</h2>
                </div>
              </div>
              <Button
                variant="ghost"
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="How should Echo address you?"
