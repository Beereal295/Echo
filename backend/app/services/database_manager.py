...
class DatabaseManager:
    ...
    async def migrate_single_user_to_multi_user(self, old_db_path: str = "echo.db", default_username: str = "user1", default_display_name: str = "Default User"):
